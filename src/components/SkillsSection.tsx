...
const SkillsSection = () => {
  ...
  return (
    <section className="skills mb-8 lg:mb-12" id="skills">
      <motion.h1
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        viewport={{ once: true }}
        className="text-2xl lg:text-4xl mb-6 lg:mb-8 font-barlow gradient-text text-glow"
      >
        {t('title')}
      </motion.h1>
      ...
      <div className="relative py-4 lg:py-8">
        ...
        <div className="relative overflow-hidden h-32 lg:h-64">
          {/* Carrossel infinito */}
              ...
              <div className="relative">
                ...
                >
                  <Image
                    ...
                    width={56}
                    height={56}
                    className="skill-icon w-10 h-10 lg:w-14 lg:h-14 filter drop-shadow-lg"
                  />
                </motion.div>
                
                {/* Tooltip com estilo do app */}
                <div 
                  className="absolute top-full left-1/2 transform -translate-x-1/2 glass-card text-white text-xs lg:text-sm px-2 lg:px-4 py-1 lg:py-2 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-[999999] mt-1 lg:mt-2"
                  style={{ zIndex: 999999 }}
                >
